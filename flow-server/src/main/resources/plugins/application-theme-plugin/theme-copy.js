 ...
 */
function handleThemeFiles(themeName, themeFolder, projectStaticAssetsOutputFolder) {
...
/**
 * Recursively copy all files found in theme folder.
...
module.exports = handleThemeFiles;
